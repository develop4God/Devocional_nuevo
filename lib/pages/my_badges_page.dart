...
class _MyBadgesPageState extends State<MyBadgesPage> {
  ...
  void _shareBadge(badge_model.Badge badge) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(
          'donate.share_badge_message'.tr().replaceAll('{badge}', badge.name),
        ),
          ...
          Expanded(
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final isUnlocked = _unlockedBadges.any(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Icon(Icons.military_tech, color: colorScheme.primary, size: 32),
