...
class _TestBadgesPageState extends State<TestBadgesPage> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            BadgeImageWidget(badge: badge, size: 120, isUnlocked: true),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.refresh), onPressed: _loadBadges),
        ],
      ),
  ...
  Widget _buildBody(ColorScheme colorScheme, TextTheme textTheme) {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text('Error al cargar badges:', style: textTheme.titleMedium),
            const SizedBox(height: 8),
            Text(
              _error!,
    ...
    if (_badges.isEmpty) {
      return const Center(child: Text('No se encontraron badges'));
    }
