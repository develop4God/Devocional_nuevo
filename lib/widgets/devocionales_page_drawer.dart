...
class DevocionalesDrawer extends StatelessWidget {
  ...
  void _shareApp(BuildContext context) {
    final message = 'drawer.share_app_message'.tr();
          ...
          builder: (context, setState) => AlertDialog(
            title: Row(
              children: [
                ...
                Text(
                  downloading
                      ? 'drawer.downloading'.tr()
                      : 'drawer.confirm_download'.tr(),
            ...
            content: Column(
              ...
              children: [
                Text(
                  'drawer.download_description'.tr(),
                  style: textTheme.bodyMedium?.copyWith(
                    color: colorScheme.onSurface,
                  ),
                ),
                if (downloading) ...[
                  ...
                  Text(
                    'drawer.downloading_progress'.tr().replaceAll(
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: IconButton(
                      ...
                      tooltip: 'drawer.close_tooltip'.tr(),
                    ),
                  ),
                ],
              ),
                ...
                child: ListView(
                  children: [
                    ...
                    drawerRow(
                      ...
                      iconColor: colorScheme.primary,
                      label: Text(
                        'drawer.notification_settings'.tr(),
                        style: textTheme.bodyMedium?.copyWith(
                          fontSize: 16,
                          color: colorScheme.onSurface,
                        ),
                        ...
                        return drawerRow(
                          ...
                          label: Column(
                            ...
                            children: [
                              hasLocalData
                                  ? Text(
                                      'drawer.devotionals_downloaded'.tr(),
                                      style: textTheme.bodyMedium?.copyWith(
                                        fontSize: 16,
                                        color: colorScheme.onSurface,
                                      ),
                              ...
                              Text(
                                hasLocalData
                                    ? 'drawer.enjoy_offline_content'.tr()
                          ...
                          onTap: () {
                            if (!hasLocalData) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                      'drawer.already_offline_message'.tr()),
                                  backgroundColor:
