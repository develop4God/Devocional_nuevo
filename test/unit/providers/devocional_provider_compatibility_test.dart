...
void main() {
  ...
  group('Backward Compatibility Tests', () {
    ...
    test('Spanish RVR1960 uses original API URL', () {
      ...
      final spanishUrl = Constants.getDevocionalesApiUrl(currentYear, 'es', 'RVR1960');
      final expectedOriginalUrl = 'https://raw.githubusercontent.com/develop4God/Devocionales-json/refs/heads/main/Devocional_year_$currentYear.json';
      
      expect(
        spanishUrl,
        equals(expectedOriginalUrl),
        reason: 'Spanish RVR1960 should use the original API URL format for backward compatibility',
      );
      ...
      expect(
        defaultUrl,
        equals(expectedOriginalUrl),
        reason: 'Default URL should be same as Spanish for backward compatibility',
      );
    });
