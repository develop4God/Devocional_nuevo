  ...
  group('SpiritualStatsService Backup Tests', () {
    ...
    group('Backup Data Structure', () {
      ...
      test('should include devotional reading data in backup', () async {
        ...
        expect(backupData['devotional_reading_data']['read_devocional_ids'],
            isA<List>());
        expect(backupData['devotional_reading_data']['reading_progress'],
            isA<Map>());
      });
    ...
    group('Reading Progress Tracking', () {
      test('should track reading progress correctly', () async {
        final prefs = await SharedPreferences.getInstance();
        await prefs
            .setStringList('readDevocionalIds', ['dev_1', 'dev_2', 'dev_3']);
    ...
    group('Performance and Data Integrity', () {
      test('should handle large datasets efficiently', () async {
        ...
        expect(stats['devotional_reading_data']['read_devocional_ids'].length,
            equals(100));
      });
      ...
      test('should maintain data consistency', () async {
        ...
        expect(stats1['devotional_reading_data']['read_devocional_ids'],
    ...
    group('Error Handling', () {
      ...
      test('should handle invalid backup data types', () async {
        ...
        final stats = await service.getAllStats();
        expect(stats['devotional_reading_data']['read_devocional_ids'],
            isA<List>());
      });
    });
  });
