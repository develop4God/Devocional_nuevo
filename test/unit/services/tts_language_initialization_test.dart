...
void main() {
  ...
  group('TTS Language Initialization Tests - Persistence Validation', () {
    ...
    test('Language preference should persist correctly in SharedPreferences',
        () async {
      // Arrange
      SharedPreferences.setMockInitialValues({});
      ...
      expect(savedLanguage, 'en-US',
          reason: 'TTS language should be persisted as en-US');
    });

    test('Language preference should support all app languages - Portuguese',
        () async {
      SharedPreferences.setMockInitialValues({});
      final prefs = await SharedPreferences.getInstance();
    ...
    test('Language preference should support all app languages - French',
        () async {
      SharedPreferences.setMockInitialValues({});
      final prefs = await SharedPreferences.getInstance();
    ...
    test('Language preference should support all app languages - Japanese',
        () async {
      SharedPreferences.setMockInitialValues({});
      final prefs = await SharedPreferences.getInstance();
    ...
    test(
      ...
      expect(savedLanguageAfterChange, 'pt-BR',
    ...
    test('Language preference can be updated during app session', () async {
      ...
      expect(prefs.getString('tts_language'), 'en-US',
