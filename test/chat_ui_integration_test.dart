...
void main() {
  group('Chat UI Widget Tests', () {
    ...
    testWidgets('ChatFloatingButton renders correctly', (WidgetTester tester) async {
      bool pressed = false;
    ...
    testWidgets('ChatMessageWidget renders user message correctly', (WidgetTester tester) async {
    ...
    testWidgets('ChatMessageWidget renders bot message correctly', (WidgetTester tester) async {
      ...
      expect(find.text('This is a response from the biblical assistant'), findsOneWidget);
      expect(find.byIcon(Icons.auto_awesome), findsOneWidget);
    });

    testWidgets('ChatOverlay renders correctly with BLoC', (WidgetTester tester) async {
      ...
      expect(find.text('Ask me anything about the Bible!\nI\'m here to help you grow spiritually.'), findsOneWidget);
      expect(find.byIcon(Icons.auto_awesome), findsOneWidget);
    ...
    testWidgets('ChatOverlay shows loading state correctly', (WidgetTester tester) async {
      final chatBloc = ChatBloc(mockChatService, mockLocalizationProvider);
    ...
    testWidgets('ChatOverlay text input works correctly', (WidgetTester tester) async {
      final chatBloc = ChatBloc(mockChatService, mockLocalizationProvider);
  ...
  group('Chat Integration Tests', () {
    testWidgets('Complete chat flow integration', (WidgetTester tester) async {
      ...
      when(() => mockChatService.sendMessage(any(), any()))
          .thenAnswer((_) async => 'Peace be with you, according to John 14:27');
