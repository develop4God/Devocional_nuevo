...
void main() {
  ...
  group('Ordinal Formatting Tests', () {
    ...
    test('should format Spanish ordinals correctly', () {
      ...
      expect(ttsService.formatBibleBook('2 Corintios'), contains('Segunda de Corintios'));
      expect(ttsService.formatBibleBook('3 Juan'), contains('Tercera de Juan'));
      expect(ttsService.formatBibleBook('Génesis'), equals('Génesis')); // No ordinal change
    });
    ...
    test('should format English ordinals correctly', () {
      ...
      expect(ttsService.formatBibleBook('2 Corinthians'), contains('Second Corinthians'));
      expect(ttsService.formatBibleBook('3 John'), contains('Third John'));
      expect(ttsService.formatBibleBook('Genesis'), equals('Genesis')); // No ordinal change
    });
    ...
    test('should format Portuguese ordinals correctly', () {
      ...
      expect(ttsService.formatBibleBook('2 Coríntios'), contains('Segundo Coríntios'));
      expect(ttsService.formatBibleBook('3 João'), contains('Terceiro João'));
      expect(ttsService.formatBibleBook('Gênesis'), equals('Gênesis')); // No ordinal change
    });
    ...
    test('should format French ordinals correctly', () {
      ...
      expect(ttsService.formatBibleBook('2 Corinthiens'), contains('Deuxième Corinthiens'));
      expect(ttsService.formatBibleBook('3 Jean'), contains('Troisième Jean'));
      expect(ttsService.formatBibleBook('Genèse'), equals('Genèse')); // No ordinal change
    });
