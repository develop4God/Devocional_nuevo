...
void main() {
  group('Backup System Integration Tests', () {
    ...
    testWidgets('should load backup settings and display correctly',
    ...
    testWidgets('should handle backup settings changes',
        (WidgetTester tester) async {
      ...
      when(() => mockRepository.saveBackupFrequency(any()))
          .thenAnswer((_) async {});
      when(() => mockRepository.saveWifiOnlyEnabled(any()))
          .thenAnswer((_) async {});
    ...
    testWidgets('should handle manual backup creation',
        (WidgetTester tester) async {
    ...
    testWidgets('should handle Google Drive authentication',
        (WidgetTester tester) async {
    ...
    testWidgets('should handle backup options updates',
        (WidgetTester tester) async {
      // Setup initial state
      when(() => mockRepository.loadBackupSettings()).thenAnswer((_) async => (
            autoBackupEnabled: false,
      ...
      when(() => mockRepository.saveBackupOptions(any()))
          .thenAnswer((_) async {});
      ...
      await container
          .read(backupProvider.notifier)
          .updateBackupOptions(newOptions);
    ...
    testWidgets('should handle errors gracefully', (WidgetTester tester) async {
      ...
      expect(container.read(backupErrorMessageProvider),
          contains('Failed to load backup settings'));
    ...
    testWidgets(
        'should maintain provider consistency across multiple operations',
        (WidgetTester tester) async {
      ...
      when(() => mockRepository.saveBackupFrequency(any()))
          .thenAnswer((_) async {});
      when(() => mockRepository.saveCompressionEnabled(any()))
          .thenAnswer((_) async {});
