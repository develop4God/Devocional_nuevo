...
void main() {
  ...
  group('DevocionalesDrawer Offline Integration', () {
    ...
    testWidgets('should open download confirmation dialog when tapped', (WidgetTester tester) async {
      when(() => mockDevocionalProvider.hasTargetYearsLocalData())
          .thenAnswer((_) async => false);
      ...
      expect(find.text('Proceder con la descarga de Devocionales una sola vez, para uso sin internet (offline)'), findsOneWidget);
      expect(find.text('Se descargarán los devocionales 2025 y 2026'), findsOneWidget);
