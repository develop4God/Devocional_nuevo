...
void main() {
  group('Compression Effectiveness Tests', () {
    test('should compress JSON data effectively', () {
      ...
      final decompressedData = CompressionService.decompressJson(
        compressedData,
      );
  ...
  group('Data Security Tests', () {
    test('should ensure data integrity through compression cycle', () {
      ...
      final testCases = [
        ...
        {
          'special_chars':
              'Test with "quotes", \'apostrophes\', and /slashes\\',
        },
      ];
    ...
    test('should handle binary data safely', () {
      ...
      final complexData = {
        ...
        'metadata': {'format': 'test', 'version': '1.0', 'checksum': 'abc123'},
      };
    ...
    test('should fail gracefully with corrupted data', () {
      ...
      expect(
        result,
        anyOf([isNull, isA<Map<String, dynamic>>()]),
